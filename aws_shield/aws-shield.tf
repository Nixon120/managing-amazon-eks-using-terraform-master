...
# Create an AWS WAFv2 rule group for the AWS WAF rule
...
# Create an AWS WAFv2 rule to include in the rule group
...
# Create an AWS WAFv2 WebACL association with the load balancer
